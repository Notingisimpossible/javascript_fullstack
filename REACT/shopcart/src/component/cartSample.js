...
export default class CartSample extends Component {
  constructor (props) {
    ...
    this.state = {
      text: '' ,//选择商品
      goods: [
        {id:1, text: '你不知道的js', price: 66},
        {id:2, text: '你不知道的vue', price: 77},
        {id:3, text: '你不知道的react', price: 88}
      ],
      cart: [],
      history: []
    }
  ...
  addGoods () {
    this.setState(prevState => ({
      goods: [...prevState.goods, {id:prevState.id, text:prevState.text, price:Math.ceil(Math.random()*25 + 50)}]
    }))
