<template>
  <el-dialog title="登录" :visible="dialogVisible" @close="cancel">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="handleOk" @close="cancel">登 录</el-button>
    </div>
  </el-dialog>
</template>
...
export default class RegisterAndLogin extends Vue {
  ...
  private handleAuthor(): void {
    ...
    window.location.href = `https://github.com/login/oauth/authorize?client_id=8c18518729d7e7af692b`
  }
};
</script>
